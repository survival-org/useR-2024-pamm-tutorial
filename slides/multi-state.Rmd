...
- Prednisone treatment reduces the transition probability into the death and abnormal prothrombin levels state
- Differences between probabilities is small (Confidence Intervalls soon to be implemented)
