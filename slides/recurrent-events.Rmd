...
---
# Schematic
An examplary schematic of a reccurr ent events data set for 5 subjects is shown below (source: `r Citet(bib, "amorim_modelling_2015")`)
...
- Data transformation as usual with `as_ped` functions, however
  + Formula contains information about entry and exit times for risk sets of spefici event number `Surv(start, stop, status)~.`
