...
- `pammtools::as_ped`: use formula special term `concurrent` to denote time-varying covariates and include all necessary cut points.
...
pammtools::pamm(ped_status ~ s(tend) + log_bili + log_protime, data = pbc_ped)
#equivalent to:
mgcv::gam(ped_status ~ s(tend) + log_bili + log_protime, data = pbc_ped,
